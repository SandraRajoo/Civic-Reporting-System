                ...
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li><a id="signup" href="homepage.html"><span class="glyphicon glyphicon-home"></span> Home</a></li>
                        </ul>    
...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
                ...
                <h2 style="text-align:center; font-family:Courier New;"><b>Guest Account - Welcome</b></h2>
                                              <hr>

        </div>
    </div>
        
            <h1 class="heading"><b>Community Map</b></h1>
            <div align="center"><b>Right Click to Drop a New Marker</b></div>
            <input id="pac-input" class="controls" type="text" placeholder="Search Box">
            <div class="container-fluid" id="google_map" style="width:100%"></div>
