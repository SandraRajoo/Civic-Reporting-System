                ...
                function map_initialize()
                {
                    ...
                    google.maps.event.addListener(map, 'rightclick', function (event) {
                        ...
                        var EditForm = '<p><div class="marker-edit">' +
                                ...
                                '<option value="stray">Stray Dogs</option>'+
...
<div class="container">
	...
	<div class="row">
	    ...
	    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
				...
				<h2>Admin Page - Welcome Admin</h2>
        ...
        <ul class="nav nav-pills">
            ...
            <li><a href="#priority" data-toggle="tab">Set Priority</a></li>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane" id="priority" >
                 <h1 class="heading">Set Priority</h1>
            <table id="prioritytable" class="display" style="margin-top:-180px;" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            <th>Type</th>
                            <th>Description</th>
        ...
        if ($result->num_rows > 0) 
            {
                ...
                {
                    echo "<tr><th>".$row["Type"]."</td><tab><th>".$row["Description"]."</td><th>".$row["Lat"]."</td><th>".$row["Lng"]."</td><th>".$row["Name"]."</td><th><a href='priority.php?id=$row[Alert_Id]'>Set Priority</a></th></tr><br>";
                }
...
?>
            ...
            <div class="tab-pane" id="complete">
             <h1 class="heading">Complete Requests</h1>
            <table id="completetable" class="display" cellspacing="0" style="margin-top:-180px;" width="100%">
                    <thead>
                        <tr>
                            <th>Type</th>
                            <th>Description</th>
        ...
        if ($result->num_rows > 0) 
            {
                while($row = $result->fetch_assoc()) 
                {
                    echo "<tr><th>".$row["Type"]."</td><tab><th>".$row["Description"]."</td><th>".$row["Lat"]."</td><th>".$row["Lng"]."</td><th>".$row["Name"]."</td><th><a href='complete.php?id=$row[Alert_Id]'>Completed</a></th></tr><br>";
                }
...
?>
            ...
            <div class="tab-pane" id="closed">
             <h1 class="heading">Terminate Requests</h1>
            
             <table id="closetable" class="display" cellspacing="0" width="100%" style="margin-top:-180px;">
                    <thead>
                        <tr>
                            <th>Type</th>
                            <th>Description</th>
        ...
        if ($result->num_rows > 0) 
            {
                while($row = $result->fetch_assoc()) 
                {
                    echo "<tr><th>".$row["Type"]."</td><tab><th>".$row["Description"]."</td><th>".$row["Lat"]."</td><th>".$row["Lng"]."</td><th>".$row["Name"]."</td><th><a href='close.php?id=$row[Alert_Id]'>Terminate</a></th></tr><br>";
                }
